...
import com.example.concurrencyapp.databinding.FragmentDetailsBinding
import com.example.concurrencyapp.utils.Constants.animationDuration
import com.example.concurrencyapp.utils.DataStatus
import com.example.concurrencyapp.utils.getCompatDrawable
import com.example.concurrencyapp.utils.isVisible
import com.example.concurrencyapp.utils.roundToThreeDecimals
import com.example.concurrencyapp.utils.roundToTwoDecimals
                            ...
                            it.data?.let { data ->
                                ...
                                when {
                                    number > 0 -> {
                                        ...
                                        imgArrow.setImageDrawable(requireContext().getCompatDrawable(
